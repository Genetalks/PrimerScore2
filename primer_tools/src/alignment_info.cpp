...
pt::alignment_info::alignment_info(const bam1_t *b, int32_t template_len) : tid(b->core.tid),
                                                                            chr(bam_get_qname(b)),
                                                                            is_rev(bam_is_rev(b))
...
void pt::alignment_info_db::build_query_tree()
{
    ...
    {
        aligned_intervals.push_back(interval_t{a->get_template_start(), a->get_template_end(), a.get()});
    }
